                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Perbaharui Data Pelanggan</h5>
                            <a href="<?= base_url('pelanggan'); ?>" class="btn btn-info btn-sm float-right">
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_pelanggan" id="nama_pelanggan" class="form-control" required value="<?= $pelanggan->nama_pelanggan ?>">
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat</label>
                                    <input type="text" name="alamat" id="alamat" class="form-control" required value="<?= $pelanggan->alamat ?>">
                                </div>
                                <div class="form-group">
                                    <label for="telepon">Telepon</label>
                                    <input type="text" name="telepon" id="telepon" class="form-control" required value="<?= $pelanggan->telepon ?>">
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="email" name="email" id="email" class="form-control" required value="<?= $pelanggan->email ?>">
                                </div>
                                <div class="form-group">
