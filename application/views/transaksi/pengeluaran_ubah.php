                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Perbaharui Data Pengeluaran</h5>
                            <a href="<?= base_url('pengeluaran'); ?>" class="btn btn-info btn-sm float-right">
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keterangan" id="keterangan" class="form-control" required value="<?= $pengeluaran->keterangan ?>">
                                </div>
                                <div class="form-group">
                                    <label for="harga">Harga</label>
                                    <input type="text" name="harga" id="harga" class="form-control" required value="<?= $pengeluaran->harga ?>">
                                </div>
                                <div class="form-group">
