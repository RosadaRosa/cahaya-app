                            ...
                            <form action="<?= base_url('barang/tambah'); ?>" method="post">
                                <div class="form-group">
                                    ...
                                    <select name="id_kategori" id="id_kategori" class="form-control" required="required">
                                        ...
                                        <?php foreach ($kategori->result() as $o) : ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_merk" id="id_merk" class="form-control" required="required">
                                        <option value="">Pilih Nama Merk</option>
                                        <?php foreach ($merk->result() as $o) : ?>
                                            <option value="<?php echo $o->id_merk ?>"><?php echo $o->merk ?> - <?php echo $o->bahan ?> - <?php echo $o->ukuran ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                               ...
                               <div class="form-group">
                                    ...
                                    <select name="id_suplier" id="id_suplier" class="form-control" required="required">
                                        ...
                                        <?php foreach ($suplier->result() as $o) : ?>
